...
from .models import Fixtures, Scores, Team_members, Teams
...
def home(request):
    ...
    # Render the index.html template with the specified context
    return render(
        request,
...
# view for team registration form
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if Teams.objects.count() >= 10:
                generate_fixtures()  # code to generate fixtures
        ...
        form = TeamMemberForm()
    # Render the register_team.html template with the specified context
    return render(request, "tournament/register_team.html", {"form": form})
...
# view for team and its members data
def team_data(request):
    teams = Teams.objects.all()
    members = Team_members.objects.all()
    # Render the teams.html template with the specified context
    return render(
        request, "tournament/teams.html", {"teams": teams, "members": members}
    )
...
def edit_score(request, fixture_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            team1_score, _ = Scores.objects.get_or_create(
                fixture=fixture, team=fixture.team1
            )
            team2_score, _ = Scores.objects.get_or_create(
                fixture=fixture, team=fixture.team2
            )
            ...
            return redirect(
                "fixtures"
            )  # Redirect to the fixture list page after editing
        else:
            # Render the form again with the validation errors displayed
            for errors in form.errors.values():
                for error in errors:
        ...
        # Initialize the form with initial data for the scores
        initial_data = {
            "team1_score": Scores.objects.get_or_create(
                fixture=fixture, team=fixture.team1
            )[0].score,
            "team2_score": Scores.objects.get_or_create(
                fixture=fixture, team=fixture.team2
            )[0].score,
        }
    ...
    # Render the edit_score.html template with the specified context
